...
gulp.task('default', function(callback) {
	...
	envProd = false
	runSequence('clean:dist', 'sass', 'ejs', 'js', 'img', 'data', 'views', 'txt', 'server', 'modules', callback)
})
...
gulp.task('watch', function(callback) {
	runSequence('clean:dist', 'default', function() {
		...
		gulp.watch(path.ejs.i, ['ejs', browserSync.reload])
...
gulp.task('production', function(callback) {
	...
	envProd = true
	runSequence('clean:dist', 'sass', 'ejs', 'js', 'img', 'data', 'views', 'txt', 'server', 'modules', () => {
